...
<?php __("Check out the new <strong>Labels Edit</strong> add-on, which gives you the possibility to edit any string that is coming from the <strong>Paid Member Subscriptions</strong> plugin.", "paid-member-subscriptions"); ?>
<?php __("More information", "paid-member-subscriptions"); ?>
...
<?php __("Paid Member Subscriptions -> Setup Wizard", "paid-member-subscriptions"); ?>
...
<?php __("Allow users to pay using credit or debit cards directly on your website through PayPal Pro.", "paid-member-subscriptions"); ?>
